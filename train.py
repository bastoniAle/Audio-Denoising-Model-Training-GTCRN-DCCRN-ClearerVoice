...
def main(args):
    ...
    elif args.network=='DCUNET_SE_48K' or args.network=='DCCRN_SE_48K' or args.network=='PHASEN_SE_48K' or args.network=='DPCRN_SE_48K' or args.network=='GTCRN_SE_48K' or args.network=='ULUNAS_SE_48K' or args.network=='DTLN_SE_48K':
        params = model.get_params(args.weight_decay)
        optimizer = torch.optim.Adam(params, lr=args.init_learning_rate)
        optimizer_disc = None
    else:
