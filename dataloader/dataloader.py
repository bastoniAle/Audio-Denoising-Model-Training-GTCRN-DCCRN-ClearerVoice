...
class AudioDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        inputs, labels = self.wav_processor.process({'inputs':data_info['inputs'],'labels':data_info['labels']}, self.segment_length, self.sampling_rate)
...
def get_dataloader(args, data_type):
    ...
    if args.network == 'FRCRN_SE_16K' or args.network == 'MossFormerGAN_SE_16K' or args.network == 'DCUNET_SE_48K' or args.network == 'DCCRN_SE_48K' or args.network == 'PHASEN_SE_48K' or args.network == 'DPCRN_SE_48K' or args.network == 'GTCRN_SE_48K' or args.network == 'ULUNAS_SE_48K' or args.network == 'DTLN_SE_48K':
